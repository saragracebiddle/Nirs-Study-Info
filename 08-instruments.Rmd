# Exercise Testing {#test}

## Lactate Threshold Exercise Test {#instr-LT}

### Specifications {#instr-LT-specs}
...
### Selecting Wattage Jumps {#instr-LT-watts}
...
## On/Off Kinetics Exercise Test {#instr-onoff}

### Specifications {#instr-onoff-specs}

The on/off kinetics test is completed on a cycle ergometer. 

Ventilatory measurements are collected breath by breath via metabolic cart (ParvoMedics OneTrue 2400, \@ref(instr-parvo)). Muscle oxygenation measurements are collected via SR-NIRS (Artinis Medical Systems PortaMon, \@ref(instr-portamon))
